...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Correlated Sampling surface over T and graph parameter."
    )
    ...
    parser.add_argument("--out_csv", type=str, default="correlated_sampling_surface.csv")
    parser.add_argument("--out_fig", type=str, default="correlated_sampling_surface.png")
...
def main():
    ...
    plot_surface(
        ...
        "T",
        "ALG / OPT ratio",
        f"Correlated Sampling vs T and {x_label} (A={args.A}, I={args.I})",
        x_values,
        Ts,
        grid,
        show=args.show,
